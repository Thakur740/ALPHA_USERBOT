...
@Client.on_message(
    filters.me & (filters.command(["rishant"], ".") | filters.regex("^alpha"))
)
async def hello_world(client: Client, message: Message):
    mg = await edit_or_reply(message, "ʀɪsʜᴀɴᴛ")
    ...
    await mg.edit("ᴛᴏᴘɪ")
    await asyncio.sleep(0.3)
    await mg.edit(" ᴊᴏʀ sᴇ ʙᴏʟᴏ ᴀʟᴘʜᴀ 𝐑𝐈𝐒𝐇𝐀𝐍𝐓 ᴊɪ ᴊᴀɪ💘")
...
async def hajqag(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "`ㅤ ʀɪsʜᴀɴᴛ🍃 : ʙᴇᴛᴇ...!! ɴᴀᴀ ᴊᴀᴍɪɴ ᴘᴇ ɴᴀ ᴀᴀsᴍᴀɴ ᴘᴇ...😉😉 ᴛᴇʀɪ ᴍᴀʏʏᴀ ᴋᴏ ᴄʜʜᴏᴅᴜɴɢᴀ ᴍᴇ #_ʟᴇɢᴇɴᴅᴡᴏʀʟᴅ ᴋᴇ ʜᴀᴠᴇʟɪ ᴘᴇ...🥵🥵.`",
        "`ᴍᴇ: ʙʜᴀɪ...ʏᴀᴀʀ ᴍᴇʀɪ ɢᴀᴀɴᴅ ᴍᴀʀᴏ ʙᴜᴛ ᴍᴜᴊʜᴇ ᴍᴀғ ᴋᴀʀᴏ...🤯`",
        "`ㅤ ʀɪsʜᴀɴᴛ🍃 : ʜɪʜɪʜɪ... ʏᴇ ʜᴜɪ ɴᴀ ʙᴀᴀᴛ....😁😁\nᴄʜᴀʟ ᴀᴀʙ ᴀᴀᴘɴɪ ʀᴀɴᴅɪ ᴍᴀʏʏᴀ ᴋᴏ #_ʟᴇɢᴇɴᴅᴡᴏʀʟᴅ ᴋᴇ ᴠᴄ ᴘᴇ ʙᴜʟᴀ ᴋᴇ ʟᴏᴠᴇ ᴜ ʙᴏʟɴᴇ  ᴋᴏ ʙᴏʟ😛😛.`",
        "`ᴍᴇ: ʙʜᴀɪ ᴘʟᴢ ɢᴀʟɪ ᴍᴛ ᴅᴏ😥.`",
        "`ㅤ ʀɪsʜᴀɴᴛ🍃 : ᴛᴏ #_ʀɪsʜᴀɴᴛ ᴋᴏ ʙᴀᴀᴘ ʙᴏʟ ᴀᴜʀ...ᴄʜᴀʟ ʙʜᴀɢ ʏᴀʜᴀ sᴇ ᴍᴄ..ʙsᴅᴋᴇ ᴋᴇ ᴘʜɪʀ ᴄᴀʟʟ ᴋɪʏᴀ ᴛᴏ #_ʟᴇɢᴇɴᴅ ᴡᴏʀʟᴅ ᴋɪ ᴠᴄ ᴘᴇ ᴛᴇʀᴇ ʙᴀᴀᴘ ᴋɪ ᴄʜᴜᴛ ᴍᴀʀᴜɴɢᴀ..🤣🤣  \n🙈𝐓ɢ 𝐏ᴇ 𝐑ᴇʜɴᴀ 𝐇ᴀɪ 𝐓ᴏ🧐 ʀɪsʜᴀɴᴛ 𝐊ᴏ 𝐁ᴀᴀᴘ💞ᴋᴀʜɴᴀ ʜᴀɪ🤪 @oy_rishu👻 :)`",
...
async def gkahgagw(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
        "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",
        "⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n⬜  [ʀɪsʜᴀɴᴛ ᴘᴀᴘᴀ ](https://t.me/oy_rishu) ⬜\n⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜",
    ]
    if message.forward_from:
        return
...
async def kocok(client: Client, message: Message):
    ...
    await e.edit("ᴀɪsᴇ ʜɪ ʀɪsʜᴀɴᴛ ᴘᴀᴘᴀ ᴘᴇʟᴇɢᴀ ʀɴᴅɪ ᴋᴇ ʙᴇᴛᴀ ")
...
async def ngebundir(client: Client, message: Message):
    await edit_or_reply(
        message,
        "`ᴋᴜᴄʜ ɴᴀ ʙʀᴏ..ʙs ʀɪsʜᴀɴᴛ sᴇ ᴘᴀɴɢᴀ ʟɪʏᴀ...ɪsʟɪʏᴇ ʙᴀʀʙᴀᴅ ᴋᴀʀ ᴅɪʏᴀ ᴍᴜᴊʜᴇ ʀɪsʜᴀɴᴛ ʙᴀᴀᴘ ɴᴇ`          \n　　　　　|"
        "\n　　　　　| \n"
        "　　　　　| \n"
        "　　　　　| \n"
        "　　　　　| \n"
